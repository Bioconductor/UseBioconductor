...
setwd("~/UseBionductor/ChIPSeq/NFYA")
```
...
frag.len <- 110
fl <- system.file(package="UseBioconductor", "data", "csaw-data-filtered.Rds")
data <- readRDS(fl)
```
...
fl <- system.file(package="UseBioconductor", "data", "csaw-normfacs.Rds")
normfacs <- readRDS(fl)
```
